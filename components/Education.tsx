  ...
  return (
    <section id="education" className="py-24 px-6 relative" ref={containerRef}>
      <div className="max-w-3xl mx-auto">
        ...
        <div className="edu-card opacity-0 glass-card p-8 md:p-10 rounded-2xl relative overflow-hidden group hover:shadow-[0_0_30px_rgba(189,52,254,0.1)] transition-all duration-500">
