...
const Experience: React.FC = () => {
  ...
  return (
    <section id="experience" aria-labelledby="experience-heading" className="py-24 px-6 relative" ref={containerRef}>
      <div className="max-w-3xl mx-auto">
        <div className="flex items-center gap-4 mb-16 experience-header opacity-0 translate-y-10">
          <h2 id="experience-heading" className="text-3xl md:text-4xl font-display font-bold text-slate-200">
            Experience
          </h2>
          <div className="h-[1px] bg-navy-700/50 flex-grow max-w-xs ml-4"></div>
        </div>

        <article className="glass-card p-8 md:p-10 rounded-2xl relative overflow-hidden experience-card opacity-0 group hover:shadow-[0_0_30px_rgba(100,255,218,0.15)] transition-all duration-500">
            ...
            <div className="flex-grow">
              ...
              <ul className="space-y-4 text-slate-400">
                <li className="flex items-start gap-3 experience-item opacity-0">
                  <span className="mt-2 h-2 w-2 rounded-full bg-accent-cyan flex-shrink-0"></span>
                  <span className="leading-relaxed">
                    Built a browser-based <strong>HDF Viewer</strong> for data analytics and integrated it into the SAC web portal to improve access to scientific payload data.
                  </span>
                </li>
                <li className="flex items-start gap-3 experience-item opacity-0">
                  <span className="mt-2 h-2 w-2 rounded-full bg-accent-cyan flex-shrink-0"></span>
                  <span className="leading-relaxed">
                    Engineered satellite data pipelines to parse, analyze, and visualize complex large-scale HDF5 file formats directly in the browser.
                  </span>
                </li>
              </ul>
            </div>
